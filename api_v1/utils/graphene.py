...
def create_open_crud_filter_field(name, filterset_class):
    @classmethod
    def resolve_queryset(
        cls, connection, iterable, info, args, filtering_args, **kwargs
    ):
    ...
    def get_resolver(self, parent_resolver):
        print(self, parent_resolver)

        output = DjangoFilterConnectionField.get_resolver(self, parent_resolver)
        print(output)
    ...
    return type(
        ...
        {"resolve_queryset": resolve_queryset, "get_resolver": get_resolver},
    )
